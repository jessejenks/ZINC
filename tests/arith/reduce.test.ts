...
const { variable: v, application: app, abstraction: abs, unit, int, add, sub, mul } = ast;
...
const cases: TestCase[] = [
	...
	[
		int(1),
		{
			...
			"call-by-name": int(1),
			"call-by-value": int(1),
			"applicative-order": int(1),
			"head-reduction": int(1),
		},
	],
	[
		add(int(1), unit()),
		{
			"normal-order": add(int(1), unit()),
			"call-by-name": add(int(1), unit()),
			"call-by-value": add(int(1), unit()),
			"applicative-order": add(int(1), unit()),
			"head-reduction": add(int(1), unit()),
		},
	],
	// arithmetic
	[
		// 1 + 2 * 3 - 4
		sub(add(int(1), mul(int(2), int(3))), int(4)),
		{
			"normal-order": int(3),
			"call-by-name": int(3),
			"call-by-value": int(3),
			"applicative-order": int(3),
			"head-reduction": int(3),
		},
	],
	// SKI
	[
	...
	[
		...
		{
			"normal-order": abs(int(3)),
			"call-by-name": abs(add(int(1), int(2))),
			"call-by-value": abs(int(3)),
			"applicative-order": abs(int(3)),
			"head-reduction": abs(int(3)),
		},
	],
	[
		app(abs(abs(v(1))), abs(add(int(1), int(2)))),
		{
			"normal-order": abs(abs(int(3))),
			"call-by-name": abs(abs(add(int(1), int(2)))),
			"call-by-value": abs(abs(add(int(1), int(2)))),
			"applicative-order": abs(abs(int(3))),
			"head-reduction": abs(abs(int(3))),
		},
	],
];
